...
function generateCatalog() {
	...
	let catalogContent = `
		...
		<head>
			...
			<link rel="icon" type="png" href="/assets/meta/favicon-pink.png">
			...
			<div class="container">
				<header class="header">
					...
					<div class="header-desc">
						<p>
							Coding can be hard, but it doesn’t have to be. One of the hardest parts about coding is simply getting started. <strong>DEMOLAND</strong> is here to help you out.
						</p>
						<p>
							<strong>DEMOLAND</strong> is a collection of coding demos, focused on web programming, presented entirely within your web browser. Try your hand at HTML, CSS, and JavaScript without having to download any additional apps.
						</p>
						<button onclick="scrollPage(400)" class="header-desc-cta">
							<svg viewBox="0 0 100 100"><polygon points="32.303 28.749 53.555 50 32.303 71.251 39.374 78.322 67.697 50 39.374 21.678 32.303 28.749"/></svg>
							<span>Scroll right to find a demo!</span>
						</button>
					</div>
